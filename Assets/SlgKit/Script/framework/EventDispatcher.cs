...
{
    private static EventDispatcherDemo m_instance;
    public static EventDispatcherDemo instance
    {
        get
        {
            if (m_instance == null) m_instance = new EventDispatcherDemo();
    ...
    public System.Action<PlayerController,Vector3> showHitEffect;

    public System.Action<PlayerController> showHitEffect1;

    public System.Action<PlayerController> showHitEffect2;

    public System.Action<PlayerController> showHitEffect3;
...
public class EventDispatcher
{
    ...
    internal void Regist<T1, T2>(int battle_End1, SkillSys skillSys, object battle_End2)
    {
